...
- My general Arabic learning [Facebook group](https://www.facebook.com/groups/adventures.in.arabic){target=\_blank}.
...
- Reading Arabic without tashkeel signs is one of the biggest challenges for students of Arabic. You can use [this tool](https://learning.aljazeera.net/en/siteinstructions/pages/0d112445-3dad-4f8c-9518-3a4c8be95f75?fbclid=iwar3bvp5t7p7e3hds_ipjj-q3vexsmvyzxueydlji1mg8oxp9tggtlf-osyw){target=\_blank} to add tashkeel marks to any text. Just paste some text and the service will add tashkeel marks for you. You can easily copy the text with tashkeel if you are converting a long text and want to read it later.
